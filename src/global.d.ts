// Global declarations for all modules
...
declare module '@docusaurus/Head' {
  ...
  const Head: React.ComponentType<React.PropsWithChildren<any>>;
  export default Head;
}

declare module '@docusaurus/Link' {
  import React from 'react';
  const Link: React.ComponentType<React.PropsWithChildren<{ to: string; [key: string]: any }>>;
  export default Link;
}

declare module '@docusaurus/router' {
  export const useHistory: () => { push: (url: string) => void; [key: string]: any };
}

declare module '@docusaurus/theme-search-algolia/client' {
  export const useAlgoliaContextualFacetFilters: () => string | string[];
  export const useSearchResultUrlProcessor: () => (url: string) => string;
}

declare module '@docusaurus/Translate' {
  import React from 'react';
  const Translate: React.ComponentType<React.PropsWithChildren<{ id: string; values?: Record<string, any>; [key: string]: any }>>;
  export default Translate;
}

declare module '@docusaurus/useDocusaurusContext' {
  const useDocusaurusContext: () => { siteMetadata: { docusaurusVersion: string; [key: string]: any }; [key: string]: any };
...
declare module '@docusaurus/theme-common' {
  export const isRegexpStringMatch: (regExpStr: string | undefined, str: string) => boolean;
  export const useSearchLinkCreator: () => (search: string) => string;
}
